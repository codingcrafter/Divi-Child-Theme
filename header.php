...
<![endif]-->
<!--[if !(IE 6) | !(IE 7) | !(IE 8)  ]><!-->
<html id="evan" <?php language_attributes(); ?>>
<!--<![endif]-->
<head>
	...
	<?php wp_enqueue_script('jquery', get_template_directory_uri() .'/js/jquery.js', array()); ?>

	<?php wp_head(); ?>

</head>

<body id="evans-body" <?php body_class(); ?>>
    
    <div class="page-progress" style="top: 0px; right: 0px; z-index: 9999; width: 3px;"></div>
